/*! UIkit 3.17.8 | https://www.getuikit.com | (c) 2014 - 2023 YOOtheme | MIT License */ (function (
  xe,
  ye,
) {
  ...
  const Go = /\B([A-Z])/g,
    ee = dt((t) => t.replace(Go, "-$1").toLowerCase()),
    Yo = /-(\w)/g,
    ke = dt((t) =>
      (t.charAt(0).toLowerCase() + t.slice(1)).replace(Yo, (e, i) =>
        i.toUpperCase(),
      ),
    ),
  ...
  function Ri(t, e) {
    e = new RegExp(e);
    for (const i of E(t))
      i.classList.remove(...Et(i.classList).filter((s) => s.match(e)));
  }
  function ni(t, e, i) {
    (i = Ft(i)), (e = Ft(e).filter((s) => !m(i, s))), O(t, e), b(t, i);
  }
  function C(t, e) {
  ...
  const tr = /.*?[^\\](?:,|$)/g,
    er = dt((t) => t.match(tr).map((e) => e.replace(/,$/, "").trim()));
  function ir(t) {
    const e = [];
    for (; t.parentNode; ) {
      const i = p(t, "id");
  ...
  const Ji = "uk-transition",
    Ki = "transitionend",
    Zi = "transitioncanceled";
  ...
  const cr = new RegExp(`${De}(enter|leave)`),
    Ot = {
      in: Us,
      out(t, e, i, s) {
        return Us(t, e, i, s, !0);
  ...
  function Wt(t, e) {
    return X(e) ? w(t).innerHTML : L(Qi(t), e);
  }
  const fr = ci("prepend"),
    L = ci("append"),
    li = ci("before"),
  ...
  function ts(t, e) {
    return E(
      E(t).map((i) => (i.hasChildNodes() ? ui(Et(i.childNodes), e) : L(i, e))),
    );
  }
  function Be(t) {
    E(t)
  ...
  function x(t) {
    const e = Se(t)
      ...
      : { height: it(t), width: Ne(t), top: 0, left: 0 };
    return {
      height: e.height,
      width: e.width,
      top: e.top,
  ...
  function S(t, e) {
    ...
    const i = x(t);
    if (t) {
      const { scrollY: s, scrollX: n } = oe(t),
        o = { height: s, width: n };
  ...
  const pr = /-?\d+(?:\.\d+)?(?:v[wh]|%|px)?/g,
    gr = dt((t) => t.toString().replace(/\s/g, "").match(pr) || []),
    mr = /(?:v[hw]|%)$/,
    vr = dt((t) => (t.match(mr) || [])[0]);
  function br(t, e) {
    return (t * $(e)) / 100;
  }
  let ze, fe;
  function wr() {
    return (
      ...
      (fe ||
        ((fe = w("<div>")),
        c(fe, { height: "100vh", position: "fixed" }),
        y(window, "resize", () => (ze = null))),
      L(document.body, fe),
      (ze = fe.clientHeight),
      lt(fe),
      ze)
  ...
  const At = typeof window < "u",
    G = At && document.dir === "rtl",
    Ut = At && "ontouchstart" in window,
    de = At && window.PointerEvent,
    pt = de ? "pointerdown" : Ut ? "touchstart" : "mousedown",
    di = de ? "pointermove" : Ut ? "touchmove" : "mousemove",
    Mt = de ? "pointerup" : Ut ? "touchend" : "mouseup",
    Vt = de ? "pointerenter" : Ut ? "" : "mouseenter",
    Fe = de ? "pointerleave" : Ut ? "" : "mouseleave",
    pi = de ? "pointercancel" : "touchcancel",
    J = {
      reads: [],
      writes: [],
      read(t) {
  ...
  function is(t) {
    Xs(J.reads),
      Xs(J.writes.splice(0)),
      (J.scheduled = !1),
      (J.reads.length || J.writes.length) && ss(t + 1);
  }
  const $r = 4;
  function ss(t) {
    J.scheduled ||
      ((J.scheduled = !0),
      t && t < $r
        ? Promise.resolve().then(() => is(t))
        : requestAnimationFrame(() => is(1)));
  }
  function Xs(t) {
    let e;
    for (; (e = t.shift()); )
  ...
  ns.prototype = {
    ...
    init() {
      this.positions = [];
      let t;
      (this.unbind = y(document, "mousemove", (e) => (t = ce(e)))),
  ...
  function sn(t) {
    mi(t) && rs(t, { func: "mute", method: "setVolume", value: 0 }),
      gi(t) && (t.muted = !0);
  }
  function nn(t) {
    return gi(t) || mi(t);
    ...
    return i.reduce(
      (r, a, l) => {
        const { scrollTop: h, scrollHeight: u, offsetHeight: f } = a,
          d = ht(a),
          g = u - d.height,
          { height: k, top: I } = i[l - 1] ? ht(i[l - 1]) : S(t);
    ...
    function s(r, a, l, h) {
      return new Promise((u) => {
        ...
        (function xt() {
          ...
          (r.scrollTop = Math[a + Bt > 0 ? "max" : "min"](
            r.scrollTop,
            f + (a + Bt) * $e,
          )),
            $e === 1 && (I === Bt || !D--)
              ? u()
              : ((I = Bt), requestAnimationFrame(xt));
        })();
      });
    }
    function n(r) {
  ...
  function ht(t) {
    ...
    for (let [r, a, l, h] of [
      ...
      se(n) ? (n = s) : (o[l] += $(c(n, `border-${l}-width`)));
      const u = o[r] % 1;
  ...
  function hs(t) {
    return t.ownerDocument
      .elementsFromPoint(S(t).left, 0)
      .find(
        (e) =>
          !e.contains(t) &&
          ((c(e, "position") === "fixed" && !Cr(t, e)) ||
            (c(e, "position") === "sticky" && B(t, T(e)))),
      );
  }
  function Cr(t, e) {
    return T(t) === T(e) && $(c(t, "zIndex")) > $(c(e, "zIndex"));
  }
  function hn(t) {
    ...
    for (const [l, [h, , u, f]] of Object.entries(ct)) {
      ...
      if (r[l] === "flip") {
        ...
        const k = S(e[l]),
          { offset: I } = i;
        g =
          Q(Q(s[u], d[u], d[f] - s[h]), k[u] - s[h] + I[l], k[f] - I[l]) - s[u];
      }
      a = cs(a, g, l);
    }
    return a;
  ...
  function Pr(t, e, { offset: i, attach: s }, n) {
    return fn(t, e, {
      attach: { element: mn(s.element, n), target: mn(s.target, n) },
      offset: Or(i, n),
    });
  }
  function _r(t, e, i) {
    return un(t, e, {
      ...i,
      attach: {
        element: i.attach.element.map(vn).reverse(),
        target: i.attach.target.map(vn).reverse(),
      },
  ...
  function zr(t) {
    return Z(t)
      ? t
      : z(t)
        ? t.split(/,(?![^(]*\))/).map((e) => (bt(e) ? St(e) : zi(e.trim())))
        : [t];
  }
  function Fr(t) {
  ...
  function Wr(t, e) {
    for (const { read: i, write: s, events: n = [] } of t._updates) {
      ...
      let o;
      i && ((o = i.call(t, t._data, e)), o && kt(o) && vt(t._data, o)),
        s &&
          o !== !1 &&
          J.write(() => {
  ...
  function je(t = {}) {
    return ge({
      handler: function (e, i) {
        ...
        for (const o of E(st(s) ? s(this) : s))
          F('[loading="lazy"]', o)
            .slice(0, n - 1)
  ...
  function bi(t) {
    return qe(
      (e, i) => ({ disconnect: y(jr(e), "scroll", i, { passive: !0 }) }),
      t,
      "scroll",
    );
  }
    ...
    return {
      observe(e, i) {
        return {
          observe: _,
          unobserve: _,
          disconnect: y(e, pt, i, { passive: !0 }),
        };
      },
      handler(e) {
        if (!It(e)) return;
        const i = ce(e),
          s = "tagName" in e.target ? e.target : T(e.target);
  ...
  var $n = {
    ...
    update: {
      ...
      write({ rows: t }) {
        for (const e of t)
          for (const i of e)
            q(i, this.margin, t[0] !== e),
              q(i, this.firstColumn, e[G ? e.length - 1 : 0] === i);
      },
      events: ["resize"],
    },
  };
  ...
  function ms(t, e = !1) {
    ...
    return (
      e && ([i, s] = qt(t)), { top: i, left: s, bottom: i + n, right: s + o }
    );
  }
  const vs = "uk-transition-leave",
    bs = "uk-transition-enter";
  function xn(t, e, i, s = 0) {
    const n = wi(e, !0),
      o = { opacity: 1 },
      r = { opacity: 0 },
      a = (u) => () => (n === wi(e) ? u() : Promise.reject()),
      l = a(async () => {
        b(e, vs),
          await Promise.all(
            kn(e).map(
      ...
      h = a(async () => {
        const u = it(e);
        b(e, bs), t(), c(N(e), { opacity: 0 }), await qr();
        const f = N(e),
          d = it(e);
        ...
        const k = g.map(async (I, D) => {
          await Ur(D * s), await M.start(I, o, i / 2, "ease");
        });
        u !== d &&
          k.push(M.start(e, { height: d }, i / 2 + g.length * s, "ease")),
  ...
  function wi(t, e) {
    return (
      e && (t.dataset.transition = 1 + wi(t)), St(t.dataset.transition) || 0
    );
  }
  function yn(t) {
    return Promise.all(
      N(t)
        ...
        .map(
          (e) =>
            new Promise((i) => j(e, "transitionend transitioncanceled", i)),
        ),
    );
  }
  function kn(t) {
  ...
  async function Vr(t, e, i) {
    ...
    s.forEach((d, g) => h[g] && c(d, h[g])),
      ...
      await Cn();
    const f = s
      .map((d, g) => T(d) === e && M.start(d, l[g], i, "ease"))
      .concat(M.start(e, a, i, "ease"));
    try {
      await Promise.all(f),
        s.forEach((d, g) => {
          p(d, u[g]),
            T(d) === e && c(d, "display", l[g].opacity === 0 ? "none" : "");
        }),
        p(e, "style", r);
    } catch {
      p(s, "style", ""), Yr(e, o);
    ...
    methods: {
      ...
      getState() {
        return this.toggles
          ...
          .reduce((t, e) => Pn(e, this.attrItem, t), {
            filter: { "": "" },
            sort: [],
          });
      },
      ...
      (s || X(o)) &&
        (n
          ? s
            ...
            : (delete i.filter[n],
              (Ce(i.filter) || "" in i.filter) && (i.filter = { "": s || "" }))
          : (i.filter = { "": s || "" })),
      X(o) || (i.sort = [o, r]),
      i
    );
  ...
  function ta(t, e, i) {
    return [...t].sort(
      (s, n) =>
        et(s, e).localeCompare(et(n, e), void 0, { numeric: !0 }) *
        (i === "asc" || -1),
    );
  }
  function ea(t) {
  ...
  var Yt = {
    ...
    methods: {
      ...
      _toggle(t, e) {
        ...
        let i;
        this.cls
          ? ((i = m(this.cls, " ") || e !== C(t, this.cls)),
            i && q(t, this.cls, m(this.cls, " ") ? void 0 : e))
          : ((i = e === t.hidden), i && (t.hidden = !e)),
          F("[autofocus]", t).some((s) => (R(s) ? s.focus() || !0 : s.blur())),
  ...
  async function sa(
    ...
    const [l = "reveal", h = "top"] =
      ...
      f = u[m(u[0], h) ? 0 : 1],
      d = f[1] === h,
      k = ["width", "height"][u.indexOf(f)],
      I = `margin-${f[0]}`,
      D = `margin-${h}`;
    let xt = x(t)[k];
    const $e = M.inProgress(t);
    ...
    s = (n * te + s) * (e ? 1 - qo : qo);
    const Uo = { [k]: e ? te : 0 };
    d && (c(t, I, te - xt + Ns), (Uo[I] = e ? Ns : te + Ns)),
      !d ^ (l === "reveal") &&
        (c(Bi, I, -te + xt), M.start(Bi, { [I]: e ? 0 : -te }, s, o));
    try {
      await M.start(t, Uo, s, o);
    } finally {
  ...
  function na(t, e, i) {
    ...
    return e
      ? (o(t, !0), Ot.in(t, s[0], n, i.origin))
      : Ot.out(t, s[1] || s[0], n, i.origin).then(() => o(t, !1));
  }
  const rt = [];
  var $s = {
    mixins: [ot, Ue, Yt],
    ...
    events: [
      {
        ...
        handler(t) {
          const { current: e, defaultPrevented: i } = t,
            { hash: s } = e;
          !i && s && he(e) && !B(s, this.$el) && w(s, document.body)
            ? this.hide()
      ...
      },
      {
        ...
        handler(t) {
          t.defaultPrevented ||
            (t.preventDefault(),
            this.isToggled() === m(rt, this) && this.toggle());
        },
      },
      {
        name: "beforeshow",
        ...
        handler(t) {
          ...
          !this.stack && rt.length
            ? (Promise.all(rt.map((e) => e.hide())).then(this.show),
              t.preventDefault())
            : rt.push(this);
        },
      },
      {
        ...
        handler() {
          this.stack &&
            c(this.$el, "zIndex", $(c(this.$el, "zIndex")) + rt.length);
          const t = [
            this.overlay && ra(this),
            this.overlay && _n(this.$el),
            this.bgClose && aa(this),
            this.escClose && la(this),
          ];
      ...
      },
      {
        ...
        self: !0,
        handler() {
          oi(this.$el) || p(this.$el, "tabindex", "-1"),
      ...
      },
      {
        ...
        self: !0,
        handler() {
          m(rt, this) && rt.splice(rt.indexOf(this), 1),
            c(this.$el, "zIndex", ""),
            rt.some((t) => t.clsPage === this.clsPage) ||
    ...
    methods: {
      ...
      show() {
        return this.container && T(this.$el) !== this.container
    ...
    return {
      ...
      show(u, f = 0, d) {
        ...
        return (
          ...
          this.translate(f),
          $i(e, "itemin", { percent: f, duration: u, timing: g, dir: i }),
          $i(t, "itemout", { percent: 1 - f, duration: u, timing: g, dir: i }),
          new Promise((k) => {
            h || (h = k),
              Promise.all([
                M.start(e, l[1], u, g),
  ...
  const ys = { passive: !1, capture: !0 },
    An = { passive: !0, capture: !0 },
    ...
    methods: {
      start() {
        (this.drag = this.pos),
          ...
          y(document, ks, this.move, ys),
          y(document, Mn, this.end, An),
      ...
      move(t) {
        ...
        if (
          (Ht(document, ks, this.move, ys),
          Ht(document, Mn, this.end, An),
          this.dragging)
        )
  ...
  function da(t) {
    return (
      c(t, "userSelect") !== "none" &&
      Et(t.childNodes).some((e) => e.nodeType === 3 && e.textContent.trim())
    );
  }
  function pa(t) {
    t._watches = [];
    for (const e of t.$options.watch || [])
      for (const [i, s] of Object.entries(e)) Dn(t, s, i);
    t._initial = !0;
  }
  function Dn(t, e, i) {
  ...
  function ga(t, e) {
    for (const { name: i, handler: s, immediate: n = !0 } of t._watches)
      ((t._initial && n) || (mt(e, i) && !ii(e[i], t[i]))) &&
        s.call(t, t[i], e[i]);
    t._initial = !1;
  }
  function ma(t) {
  ...
  function va(t) {
    t._hasComputed &&
      (Hr(t, { read: () => ga(t, Nn(t)), events: ["resize", "computed"] }),
      wa(),
      Ge.add(t));
  }
  function ba(t) {
  ...
  function $a(t) {
    ...
    for (const e of t.$options.events || [])
      if (mt(e, "handler")) Is(t, e);
      else for (const i in e) Is(t, e[i], i);
  }
  function xa(t) {
  ...
  function Is(t, e, i) {
    ...
    !n ||
      (h && !h.call(t)) ||
      t._events.push(
        y(n, s, l ? (z(l) ? l : l.call(t, t)) : null, z(o) ? t[o] : o.bind(t), {
          passive: a,
          capture: r,
          self: u,
        }),
  ...
  function ya(t) {
    ...
    for (const e of t.$options.observe || [])
      if (mt(e, "handler")) Fn(t, e);
      else for (const i of e) Fn(t, i);
  }
  function zn(t, ...e) {
    t._observers.push(...e);
  }
  ...
  function Fn(t, e) {
    ...
    st(s) && !mt(t, l) && Bn(t, l, () => s.call(t, t)),
      (n = z(n) ? t[n] : n.bind(t)),
      st(o) && (o = o.call(t, t));
    const h = mt(t, l) ? t[l] : s,
      u = i(h, n, o, a);
    st(s) &&
      Z(t[l]) &&
      u.unobserve &&
      Dn(t, { handler: Sa(u), immediate: !1 }, l),
      zn(t, u);
  }
  function Sa(t) {
    return (e, i) => {
  ...
  let Ea = 0;
  function Ln(t, e = {}) {
    (e.data = Oa(e, t.constructor.options)),
      (t.$options = Le(t.constructor.options, e, t)),
      (t.$props = {}),
      (t._uid = Ea++),
      Pa(t),
      _a(t),
  ...
  function Oa({ data: t = {} }, { args: e = [], props: i = {} }) {
    Z(t) &&
      (t = t
        .slice(0, e.length)
        .reduce((s, n, o) => (kt(n) ? vt(s, n) : (s[e[o]] = n), s), {}));
  ...
  (ut.util = Ar), (ut.options = {}), (ut.version = "3.17.8");
  const Aa = "uk-",
    Xt = "__uikit__",
    be = {};
  function Wn(t, e) {
    ...
    return (
      ...
      ut._initialized &&
        !n.functional &&
        requestAnimationFrame(() => Ye(t, `[${s}],[data-${s}]`)),
      (be[s] = n)
    );
  }
  function Ye(t, e, i, ...s) {
        ...
        navItems(t) {
          for (const e of t) {
            ...
            if (bt(i)) {
              const r = St(i),
                a = this.slides[r];
              a && (a.id || (a.id = Dt(this, a, `-item-${i}`)), (o = a.id)),
                (n = this.t("slideX", $(i) + 1)),
                p(s, "role", "tab");
            } else
              this.list &&
                (this.list.id || (this.list.id = Dt(this, this.list, "-items")),
                (o = this.list.id)),
                (n = this.t(i));
      ...
      methods: {
        updateNav() {
          ...
          for (const e of this.navItems) {
            ...
            if (bt(i)) {
              const o = St(i) === t;
              q(e, this.clsActive, o),
                p(s, { "aria-selected": o, tabindex: o ? null : -1 }),
                o && s && A(T(e), ":focus-within") && s.focus();
            } else
              q(
                e,
                "uk-invisible",
      ...
      methods: {
        show(t, e = !1) {
          ...
          const r = this.getIndex(this.index),
            a = C(this.slides, this.clsActive) && this.slides[r],
        ...
        getIndex(t = this.index, e = this.index) {
          return Q(
            at(t, this.slides, e, this.finite),
            0,
  ...
  var Vn = {
    ...
    Yn = {
      ...
      events: [
        { name: `${di} ${pt} keydown`, handler: "showControls" },
        {
          name: "click",
          self: !0,
          delegate() {
        ...
        },
        {
          ...
          async handler(t, e) {
            ...
            if (
              ...
              y(h, "load", () => this.setItem(e, h)),
                y(h, "error", () => this.setError(e));
              ...
              y(h, "loadedmetadata", () => this.setItem(e, h)),
                y(h, "error", () => this.setError(e));
      ...
      if (((this.matchMedia = !0), t)) {
        ...
        const e = () => {
          (this.matchMedia = this.mediaObj.matches),
            v(this.$el, Lt("mediachange", !1, !0, [this.mediaObj]));
        };
  ...
  function ja(t, e) {
    if (z(t)) {
      if (ft(t, "@")) t = $(c(e, `--uk-breakpoint-${t.substr(1)}`));
  ...
  function Va(t, e, i) {
    ...
    const s = Ti(i),
      n = Jn(e);
    return (
      (i = we(i.reverse(), (o) => ((o = $(o)), s === "%" ? (o * n) / 100 : o))),
      i.some(([o]) => o)
  ...
  var Ja = {
    ...
    computed: {
      target: ({ target: t }, e) => no((t && nt(t, e)) || e),
      start({ start: t }) {
    ...
    observe: [
      ps(),
      bi({ target: ({ target: t }) => t }),
      gt({ target: ({ $el: t, target: e }) => [t, e, $t(e, !0)] }),
    ],
    update: {
      read({ percent: t }, e) {
        ...
        const i = t;
        return (
          (t = Ka(ls(this.target, this.start, this.end), this.easing)),
    ...
    return {
      ...
      show(h, u = 0, f) {
        ...
        return (
          ...
          new Promise((g) => {
            l || (l = g),
              M.start(o, { transform: W(-a * (G ? -1 : 1), "px") }, h, d).then(
                l,
                _,
              );
          })
      ...
      translate(h) {
        ...
        c(
          o,
          "transform",
          W(Q(-a + (u - u * h), -Ei(o), x(o).width) * (G ? -1 : 1), "px"),
        );
        ...
        for (const k of N(o)) {
          const I = m(f, k),
            ...
            $e =
              D ||
              (!xt &&
                (I || (i * (G ? -1 : 1) === -1) ^ (Pi(k, o) > Pi(t || e))));
          _s(k, `itemtranslate${$e ? "in" : "out"}`, {
            dir: i,
            percent: xt ? 1 - h : D ? h : I ? 1 : 0,
          });
        }
      },
      percent() {
        return Math.abs(
          (c(o, "transform").split(",")[4] * (G ? -1 : 1) + r) / (a - r),
        );
      },
      getDistance() {
        return Math.abs(a - r);
  ...
  function Pi(t, e) {
    return (
      (t && (es(t).left + (G ? x(t).width - x(e).width : 0)) * (G ? -1 : 1)) ||
      0
    );
  }
  function lo(t, e) {
      ...
      sets({ sets: t }) {
        ...
        for (let n = 0; n < this.length; n++) {
          ...
          e + o > s && (e = 0),
            this.center
              ? e < s / 2 &&
                e + o + x(at(+n + 1, this.slides)).width / 2 > s / 2 &&
                (i.push(+n), (e = s / 2 - o / 2))
      ...
      beforeitemshow(t) {
        ...
        const i =
          this.dir < 0 || !this.slides[this.prevIndex]
            ...
            : this.prevIndex;
        (this.duration =
          Un(this.avgWidth / this.velocity) *
    ...
    methods: {
      ...
      updateActiveClasses() {
        ...
        for (const i of this.slides) {
          ...
          for (const n of F(_e, i))
            mt(n, "_tabindex") || (n._tabindex = p(n, "tabindex")),
    ...
    events: [
      {
        ...
        handler({
          ...
          J.read(() => {
            if (!this.matchMedia) return;
            const o = this.getCss(uo(t, n, e)),
              r = this.getCss(co(t) ? 0.5 : n > 0 ? 1 : 0);
            J.write(() => {
      ...
      update: {
        read() {
          ...
          return (
            ...
            { height: e - ue(this.list, "height", "content-box") }
          );
        },
        write({ height: t }) {
      ...
      watch: {
        ...
        handles(t, e) {
          c(e, { touchAction: "", userSelect: "" }),
            c(t, { touchAction: Ut ? "none" : "", userSelect: "none" });
        },
      },
      update: {
        write(t) {
          ...
          const h = this.getSortable(o),
            u = cl(r.target, l, o, e, i, r === h && t.moved !== l);
          u !== !1 &&
            ((u && o === u) ||
      ...
      methods: {
        init(t) {
          ...
          !n ||
            ...
            (this.placeholder = n),
            (this.origin = { target: e, index: le(n), ...this.pos }),
            y(document, di, this.move),
            y(document, Mt, this.end),
        ...
        move(t) {
          ...
          if (
            (Ht(document, di, this.move),
            Ht(document, Mt, this.end),
            !this.drag)
          )
            return;
          al();
  ...
  function cl(t, e, i, s, n, o) {
    ...
    if (!o)
      return ul(t, i) || n < r.top + r.height / 2 ? e : e.nextElementSibling;
    const a = i.getBoundingClientRect(),
      l = go([r.top, r.bottom], [a.top, a.bottom]),
      [h, u, f, d] = l
        ? [s, "width", "left", "right"]
        : [n, "height", "top", "bottom"],
      g = a[u] < r[u] ? r[u] - a[u] : 0;
          ...
          y(this.tooltip, "toggled", (t, e) => {
            ...
            const o = [
              j(
                ...
                !1,
                (r) =>
                  (r.type === pt && !B(r.target, this.$el)) ||
                  (r.type === "keydown" && r.keyCode === P.ESC),
              ),
              y([document, ...Gt(this.$el)], "scroll", i, { passive: !0 }),
            ];
  ...
  var ml = {
    ...
    events: {
      ...
      dragover(t) {
        _i(t), b(this.$el, this.clsDragover);
      },
      dragleave(t) {
  ...
  function wl(t, e) {
    return new Promise((i, s) => {
      ...
      y(n, "load", () => {
        ...
        n.status === 304
          ? i(n)
          : s(vt(Error(n.statusText), { xhr: n, status: n.status }));
      }),
        y(n, "error", () => s(vt(Error("Network Error"), { xhr: n }))),
        y(n, "timeout", () => s(vt(Error("Network Timeout"), { xhr: n }))),
        n.send(e.data);
    });
  }
  var $l = Object.freeze({
  ...
  function bo(t) {
    v(document, "uikit:init", t),
      document.body && Ct(document.body, wo),
      new MutationObserver((e) => e.forEach(yl)).observe(document, {
        subtree: !0,
        childList: !0,
      }),
    ...
    events: [
      {
        ...
        async handler(t) {
          ...
          (t.type === "keydown" && t.keyCode !== P.SPACE) ||
            ...
            (this._off = Cl(t.target)),
            await this.toggle(le(this.toggles, t.current)),
            this._off());
        },
      },
      {
    ...
    update() {
      ...
      for (const e in this.items) {
        ...
        p(i, {
          ...
          V(s, "ul") && p(N(s), "role", "presentation");
      }
    },
    methods: {
      toggle(t, e) {
  ...
  async function Il(
    ...
    c(a, "overflow", "hidden");
    const l = $(c(a, "height"));
    await M.cancel(a), Oi(i, !1);
    const h = zt(["marginTop", "marginBottom"], (f) => c(i, f)) + x(i).height,
      u = l / h;
    (s = (n * h + s) * (e ? 1 - u : u)),
      c(a, "height", l),
  ...
  var yo = {
      ...
      connected() {
        this.autoplay === "inview" &&
          ...
          this.automute && sn(this.$el);
      },
      observe: [
        ge({
          filter: ({ $el: t, autoplay: e }) => e && nn(t),
          handler([{ isIntersecting: t }]) {
            t ? tn(this.$el) : en(this.$el);
          },
          args: { intersecting: !1 },
          options: ({ $el: t, autoplay: e }) => ({
            root: e === "inview" ? null : T(t),
          }),
        }),
      ],
    },
    Pl = {
      ...
      observe: gt({
        target: ({ $el: t }) => [ko(t) || T(t)],
        filter: ({ $el: t }) => !So(t),
      }),
      update: {
        read() {
          if (So(this.$el)) return;
          const { ratio: t, cover: e } = si,
  ...
  var Io = {
    ...
    computed: {
      ...
      target({ target: t, targetX: e, targetY: i }, s) {
        return (
          e || (e = t || this.targetEl),
          i || (i = t || this.targetEl),
          [e === !0 ? window : nt(e, s), i === !0 ? window : nt(i, s)]
        );
      },
    },
    created() {
    ...
    connected() {
      b(this.$el, "uk-drop", this.clsDrop),
        this.toggle && !this.targetEl && (this.targetEl = Al(this)),
      ...
      },
      {
        ...
        handler() {
          ...
          const t = [
            ...
            Dl(this),
            Nl(this),
            this.autoUpdate && Co(this),
            this.closeOnScroll && Bl(this),
    ...
    methods: {
      ...
      hide(t = !0, e = !0) {
        ...
        this.clearTimers(),
          ...
          (this.isDelaying = _l(this.$el).some((s) => this.tracker.movesTo(s))),
          t && this.isDelaying
      ...
      position() {
        O(this.$el, "uk-drop-stack"),
          ...
          (this.$el.hidden = !0);
        const t = this.target.map((n) => Ol(this.$el, n)),
  ...
  function Al(t) {
    const { $el: e } = t.$create("toggle", nt(t.toggle, t.$el), {
      target: t.$el,
      mode: t.mode,
    });
  ...
  function Ml(t) {
    const e = () => t.$emit(),
      i = [os(e), He(Gt(t.$el).concat(t.target), e)];
  ...
  var To = {
    ...
    computed: {
      dropbarAnchor: ({ dropbarAnchor: t }, e) => nt(t, e) || e,
      dropbar({ dropbar: t }) {
        return t
          ? ((t =
              this._dropbar ||
      ...
      },
      {
        ...
        handler(t) {
          ...
          s === P.DOWN &&
            ...
            (t.preventDefault(), (e = w(_e, n.$el)) == null || e.focus()),
            Eo(t, this.items, n);
        },
      },
      {
          ...
          const e = this.getDropdown(t),
            i = () => {
              ...
              c(
                ...
                this.transitionTo(
                  o - n + $(c(t, "marginBottom")) + this.dropbarOffset,
                  t,
                );
            };
  ...
  function Eo(t, e, i) {
    ...
    a === P.HOME
      ...
      ~l &&
        ...
        e[at(l, e, e.indexOf(i.targetEl || r))].focus());
  }
  var zl = {
      mixins: [ot],
      args: "target",
      ...
      update() {
        ...
        if (!e) return;
        let s;
        const n = qi(e) ? "value" : "textContent",
          o = e[n],
          r =
            (t = i.files) != null && t[0]
              ? i.files[0].name
          ...
          read(t) {
            ...
            if (
              ...
              !(i || s || n) ||
                Po(e) ||
                e[0].some((k, I) =>
                  e.some((D) => D[I] && D[I].offsetWidth !== k.offsetWidth),
                ))
            )
            ...
            const h = a.map((k) => zt(k, "offsetHeight") + r * (k.length - 1)),
              u = Math.max(0, ...h);
            let f, d, g;
            return (
              (s || n) &&
                ((f = h.map((k, I) => (n ? u - k + s : s / (I % 2 || 8)))),
                n || (s = Math.max(...h.map((k, I) => k + f[I] - u))),
                (d = tt(this.parallaxStart, "height", this.$el, !0)),
                (g = tt(this.parallaxEnd, "height", this.$el, !0))),
              {
                columns: a,
                translates: l,
                scrollColumns: f,
  ...
  function Ll(t, e) {
    ...
    return $(i ? c(i, "marginTop") : c(t[0][0], "paddingLeft"));
  }
  function Wl(t) {
    const e = [];
  ...
  var Rl = {
    ...
    update: {
      read() {
        return {
          rows: (this.row ? gs(this.elements) : [this.elements]).map(jl),
        };
      },
      write({ rows: t }) {
  ...
  var Ul = {
      ...
      update: {
        read() {
          ...
          let t = "";
          const e = ue(this.$el, "height", "content-box"),
          ...
          if (((t = `calc(${r ? "100vh" : `${o}px`}`), this.expand)) {
            ...
            this.offsetBottom === !0
              ...
              : bt(this.offsetBottom)
                ...
                : this.offsetBottom && ie(this.offsetBottom, "px")
                  ? (t += ` - ${$(this.offsetBottom)}px`)
                  : z(this.offsetBottom) &&
                    (t += ` - ${x(nt(this.offsetBottom, this.$el)).height}px`);
          }
  ...
  const Ai = {
    ...
    Zt = {
      args: !1,
      extends: As,
      data: (t) => ({ icon: ee(t.constructor.options.name) }),
      beforeConnect() {
        b(this.$el, this.$options.id);
      },
    },
      ...
      beforeConnect() {
        if (
          ((this.icon =
            ...
            ae(this.$el, ".uk-search-large").length
              ? "search-large"
              : ae(this.$el, ".uk-search-navbar").length
                ? "search-navbar"
                : this.$props.icon),
          !wt(this.$el, "aria-label"))
        )
          if (
            C(this.$el, "uk-search-toggle") ||
            C(this.$el, "uk-navbar-toggle")
          ) {
    ...
    vh = { extends: Qt, i18n: { label: "Open menu" } },
    bh = {
      extends: Qt,
      i18n: { label: "Close" },
      beforeConnect() {
    ...
    wh = { extends: Qt, i18n: { label: "Open" } },
    $h = { extends: Qt, i18n: { label: "Back to top" } },
  ...
  function Sh(t) {
    return Ai[t]
      ? (Mi[t] || (Mi[t] = w((Ai[Ih(t)] || Ai[t]).trim())), Mi[t].cloneNode(!0))
      : null;
  }
  function Ih(t) {
  ...
  var Th = {
    ...
    connected() {
      ...
      Ch && Di(this.$el) && ((this.$el.loading = "lazy"), Ms(this.$el)),
        Ah(this.$el);
    },
    disconnected() {
    ...
    methods: {
      load() {
        ...
        const t = Di(this.$el)
          ? this.$el
          : Ph(this.$el, this.dataSrc, this.sources);
  ...
  function Ms(t, e) {
    if (Di(t)) {
      ...
      e &&
        ...
        (c(t, "backgroundImage", `url(${Gi(e)})`), v(t, Lt("load", !1)));
  }
  ...
  function Bh({ modal: t }) {
    (t.dialog = function (i, s) {
      ...
      (t.alert = function (i, s) {
        return e(
          ({ i18n: n }) =>
            `<div class="uk-modal-body">${z(i) ? i : Wt(i)}</div> <div class="uk-modal-footer uk-text-right"> <button class="uk-button uk-button-primary uk-modal-close" autofocus>${n.ok}</button> </div>`,
          s,
        );
      }),
      (t.confirm = function (i, s) {
        return e(
          ({ i18n: n }) =>
            `<form> <div class="uk-modal-body">${z(i) ? i : Wt(i)}</div> <div class="uk-modal-footer uk-text-right"> <button class="uk-button uk-button-default uk-modal-close" type="button">${n.cancel}</button> <button class="uk-button uk-button-primary" autofocus>${n.ok}</button> </div> </form>`,
          s,
          () => Promise.reject(),
        );
      }),
      ...
      events: [
        {
          ...
          handler({ target: t }) {
            ...
            const i = () =>
              (this._mode = Fh(this.navbarContainer, "uk-light", "uk-dark"));
            if (e === "behind") {
              const s = Do(this.$el);
      ...
      methods: {
        ...
        registerColorListener() {
          const t =
            ...
            C(this.navbarContainer, "uk-navbar-transparent") &&
            !Wh(this.navbarContainer) &&
            !F(".uk-drop", this.dropContainer)
          ...
          t &&
            (this._colorListener = Lh(this.navbarContainer, () => {
              const { left: e, top: i, height: s } = S(this.navbarContainer),
                n = { x: e, y: Math.max(0, i) + s / 2 },
                o = F(this.selTransparentTarget).find((a) => Te(n, S(a))),
  ...
  function Fh(t, ...e) {
    for (const i of e) if (C(t, i)) return O(t, i), i;
  }
  async function Hh() {
  ...
  var Rh = {
    ...
    events: [
      ...
      },
      {
        ...
        handler() {
          this.mode === "reveal" &&
            !C(T(this.panel), this.clsMode) &&
            (ui(this.panel, "<div>"), b(T(this.panel), this.clsMode));
  ...
  var Uh = {
      ...
      computed: {
        container: ({ selContainer: t }, e) => U(e, t),
        content: ({ selContent: t }, e) => U(e, t),
      },
    ...
    Vh = {
      ...
      observe: gt({ target: ({ $el: t }) => [t, T(t)] }),
      update: {
        read() {
          return R(this.$el) && this.width && this.height
            ? { width: Ne(T(this.$el)), height: this.height }
            : !1;
        },
        write(t) {
          it(
            this.$el,
            si.contain({ height: this.height, width: this.width }, t).height,
          );
        },
        events: ["resize"],
      },
  ...
  var Jh = {
      ...
      observe: ge({
        ...
        handler(t) {
          ...
          for (const { target: i, isIntersecting: s } of t) {
            e.has(i) ||
              e.set(i, { cls: et(i, "uk-scrollspy-class") || this.cls });
            const n = e.get(i);
    ...
    Kh = {
      ...
      computed: {
        links: (t, e) => F('a[href*="#"]', e).filter((i) => i.hash && he(i)),
        elements({ closest: t }) {
      ...
      update: [
        {
          read() {
            const t = this.links.map(Ui).filter(Boolean),
              { length: e } = t;
    ...
    Zh = {
      ...
      connected() {
        (this.start = zo(this.start || this.top)),
          (this.end = zo(this.end || this.bottom)),
          (this.placeholder =
      ...
      observe: [
        ps(),
        bi({ target: () => document.scrollingElement }),
        gt({ target: ({ $el: t }) => [t, document.scrollingElement] }),
      ],
      events: [
        {
              ...
              setTimeout(() => {
                ...
                this.isFixed &&
                  ...
                  (t.scrollTop =
                    e.top -
                    i.height -
                    tt(this.targetOffset, "height", this.placeholder) -
                    tt(this.offset, "height", this.placeholder));
              });
          },
        },
        {
      ...
      update: [
        {
          read({ height: t, width: e, margin: i, sticky: s }) {
            ...
            n && (Ho(this.$el), this.hide()),
              this.active ||
                (({ height: t, width: e } = S(this.$el)),
                (i = c(this.$el, "margin"))),
              n && this.show();
            const o = tt("100vh", "height"),
              r = it(window),
            ...
            return (
              (s =
                ...
                !this.showOnUp &&
                k + u === d &&
                I === Math.min(a, Ds("!*", this.$el, 0, !0) - g - u + f) &&
                c(T(this.$el), "overflowY") === "visible"),
              {
                start: k,
                end: I,
                offset: u,
          ...
          write({ height: t, width: e, margin: i, offset: s, sticky: n }) {
            if (
              ((this.inactive || n || !this.isFixed) && Fo(this.$el),
              this.inactive)
            )
              return;
          ...
          write(t, e) {
            ...
            if (
              ...
              if (
                ...
                if (!this.isFixed) {
                  Ot.inProgress(this.$el) &&
                    l > r &&
                    (Ot.cancel(this.$el), this.hide());
                  return;
                }
                ...
                this.isFixed
                  ? this.update()
                  : this.animation && r > u
                    ? (this.show(), Ot.in(this.$el, this.animation).catch(_))
                    : (Ho(this.selTarget), this.show());
          },
  ...
  function Ds(t, e, i, s) {
    ...
    if (bt(t) || (z(t) && t.match(/^-?\d/))) return i + tt(t, "height", e, !0);
    {
      ...
      return S(n).bottom - (s && n && B(e, n) ? $(c(n, "paddingBottom")) : 0);
    }
  }
  function zo(t) {
  ...
  var Qh = {
    ...
    methods: {
      async getSvg() {
        return V(this.$el, "img") &&
          !this.$el.complete &&
          this.$el.loading === "lazy"
          ? new Promise((t) => j(this.$el, "load", () => t(this.getSvg())))
          : ec(await tc(this.src), this.icon) ||
  ...
  var Ro = {
      ...
      watch: {
        ...
        connectChildren() {
          ...
          for (const e of this.connects)
            N(e).forEach((i, s) => q(i, this.cls, s === t));
          this.$emit();
        },
        toggles(t) {
          this.$emit();
      ...
      observe: [
        je({ targets: ({ connectChildren: t }) => t }),
        wn({ target: ({ connects: t }) => t, filter: ({ swiping: t }) => t }),
      ],
      events: [
        {
          name: "click keydown",
        ...
        },
        {
          ...
          el() {
            return this.connects.concat(
              this.itemNav ? Ae(this.itemNav, this.$el) : [],
            );
          },
          delegate() {
            return `[${this.attrItem}],[data-${this.attrItem}]`;
      ...
      methods: {
        ...
        show(t) {
          const e = this.toggles.filter((r) => !A(r, Bs)),
            i = this.index(),
            s = at(!ei(t) || m(e, t) ? t : 0, e, at(this.toggles[i], e)),
            n = at(e[s], this.toggles);
  ...
  var rc = {
      ...
      connected() {
        m(this.mode, "media") ||
          (oi(this.$el) || p(this.$el, "tabindex", "0"),
          !this.cls && V(this.$el, "a") && p(this.$el, "role", "button"));
      },
      ...
      events: [
        {
          ...
          handler(t) {
            (this._preventClick = null),
              !(!It(t) || ne(this._showState) || this.$el.disabled) &&
                (v(this.$el, "focus"),
                j(
                  document,
                  pt,
        ...
        {
          name: `mouseenter mouseleave ${Vt} ${Fe} focus blur`,
          filter() {
            return m(this.mode, "hover");
          },
          handler(t) {
            if (It(t) || this.$el.disabled) return;
            const e = m(["mouseenter", Vt, "focus"], t.type),
  ...
  return (
    _t(ac, (t, e) => ut.component(e, t)),
    xl(ut),
    _t($l, (t, e) => ut.component(e, t)),
    ut
  );
});
